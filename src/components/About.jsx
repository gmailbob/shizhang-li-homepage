...
import cv from '../assets/CV_Shizhang_Li.pdf';
    ...
    <div>
      ...
      <div className="About-content">
        <Typography>
          ...
          <Paragraph>
            I am a Donald J. Lewis Research Assistant Professor in the Mathematics Department at University of Michigan. I am interested in arithmetic geometry. Here is my <a href={cv}> CV</a>.
        </Paragraph>
          <Paragraph>
